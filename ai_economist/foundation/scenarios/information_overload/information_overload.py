...
class InformationOverload(BaseEnvironment):
    """
    A simple model featuring dynamic information overload .
    ...
    def __init__(
        self,
        *base_env_args,
        agent_reward_type="reward_minus_message_cost",
        #isoelastic_eta=0.23,
        #labor_exponent=2.0,
        #labor_cost=1.0,
        planner_reward_type="total_messages_reward_balanced_messages",
